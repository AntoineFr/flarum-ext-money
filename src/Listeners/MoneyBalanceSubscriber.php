...
{
    private const SOURCE_POST_WAS_POSTED = 'POSTWASPOSTED';
    private const SOURCE_POST_WAS_RESTORED = 'POSTWASRESTORED';
    private const SOURCE_POST_WAS_HIDDEN = 'POSTWASHIDDEN';
    private const SOURCE_POST_WAS_DELETED = 'POSTWASDELETED';
    private const SOURCE_DISCUSSION_WAS_STARTED = 'DISCUSSIONWASSTARTED';
    private const SOURCE_DISCUSSION_WAS_RESTORED = 'DISCUSSIONWASRESTORED';
    private const SOURCE_DISCUSSION_WAS_HIDDEN = 'DISCUSSIONWASHIDDEN';
    private const SOURCE_DISCUSSION_WAS_DELETED = 'DISCUSSIONWASDELETED';
    private const SOURCE_USER_WILL_BE_SAVED = 'USERWILLBESAVED';
    private const SOURCE_POST_WAS_LIKED = 'POSTWASLIKED';
    private const SOURCE_POST_WAS_UNLIKED = 'POSTWASUNLIKED';
